...
#define CMD_RESET_FUNC_ADD(f)	{static CMD_RESET_FUNC_LIST_NODE node={f,cmd_reset_func_node};cmd_reset_func_node=&node;}

extern Fifo *fifo_cmd_page;
extern int fifo_cmd_page_enabled;
