...
#undef  HANDLER
#define HANDLER(code)	__attribute__((weak)) int cmd_handler_0x1d_##code(uint8_t *Cmd,int CmdLen,int *pCmdLen,void (*tx)(char *buf,int len));
#undef  pHANDLER
#define pHANDLER(code)	cmd_handler_0x1d_##code
...
int (* const gCmdHandler0x1d_Array[256])(uint8_t *Cmd,int CmdLen,int *pCmdLen,void (*tx)(char *buf,int len))=
{
